...
import Favorite from '../../assets/img/heart-icon.png';



import API from '../../API';

import { addFavoriteAction, fetchFavoriteAction, deleteFavoriteAction, errorFavoriteAction } from '../../reducks/favorite/actions';
const api = new API();
...
const Item = ({ item }) => {
    ...
    const addFavorites = addFavoriteBody => {
